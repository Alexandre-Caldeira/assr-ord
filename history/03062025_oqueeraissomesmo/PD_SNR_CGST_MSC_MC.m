...
%% Viz
load('workspace_PD_SNR_CGST_MSC_MC.mat')
figure(3)
subplot(2,2,4)
...
grid on
ylim([0,100])
title('TPR','FontSize',15)
ylabel('PD [%]', 'FontSize',15)
xlabel('SNR [dB]', 'FontSize',15)
area([-30,-30,0],[0,100,100], 'FaceColor','g', 'FaceAlpha',0.2)
...
grid on
ylim([0,2])
title('FPR','FontSize',15)
ylabel('\alpha [%]', 'FontSize',15)
xlabel('SNR [dB]', 'FontSize',15)
area([-30,-30,0],[0,100,100], 'FaceColor','r', 'FaceAlpha',0.2)
...
grid on
ylim([98,100])
title('TNR','FontSize',15)
ylabel('PR [%]', 'FontSize',15)
% xlabel('SNR [dB]', 'FontSize',15)
area([-30,-30,0],[0,100,100], 'FaceColor','g', 'FaceAlpha',0.2)
