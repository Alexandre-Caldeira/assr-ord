classdef DataLoader < handle
    ...
    properties (SetAccess = protected)
        ...
        % Signal Parameters
        signalFrequencies = [82 84 86 88 90 92 94 96]-1; % Frequencies expected to contain signal
        ...
        function success = loadExperiment(obj, subjectIndex, stimulusIndex)
            ...
            try
                ...
                if isfield(data, 'x') && isfield(data, 'Fs')
                    ...
                    % Ensure nChannels reflects the actual channels used AFTER potential adjustment
                    obj.nChannels = numel(obj.channels);
