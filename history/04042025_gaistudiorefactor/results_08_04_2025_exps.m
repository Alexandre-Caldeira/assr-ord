...
% 10 min e meio fix(linspace(1,240, 10)) fix(linspace(20,140, 10))
config.ord_startWindows = fix(linspace(1,240, 5)); % Only used if method = 'fixedK'
...
config.ord_stepSize = fix(linspace(24,240, 15));     % Only used if method = 'fixedStep'
...
config.groupingVar = 'stepSize'; % Variable to group by
